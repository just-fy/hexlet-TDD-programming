...
export const getName = self =>
  ...
  // то есть getMethod(self, 'getName') - должен возвращать функцию,
  // которая применится к самой карте cons(name, health), например car

// BEGIN (write your solution here)
export const damage = (self, health) =>
  getMethod(self, 'damage')(contents(self), health); // здесь getMethod(self, 'damage') должен также возвращать функцию, например для простой карты cdr
// END
